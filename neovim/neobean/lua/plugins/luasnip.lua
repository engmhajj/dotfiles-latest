...
return {
  ...
  opts = function(_, opts)
    ...
    table.insert(
      ...
      s({
        trig = "dotfileslatest",
        name = "Adds -> [my dotfiles](https://github.com/engmhajj/dotfiles-latest)",
        desc = "Add link to https://github.com/engmhajj/dotfiles-latest",
      }, {
        t("[my dotfiles](https://github.com/engmhajj/dotfiles-latest)"),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "☕ Support me -> https://ko-fi.com/engmhajj",
          "☑ My Twitter -> https://x.com/engmhajj",
          "❤‍🔥 My tiktok -> https://www.tiktok.com/@engmhajj",
          "My dotfiles (remember to star them) -> https://github.com/engmhajj/dotfiles-latest",
          "A link to my resume -> https://resume.engmhajj.com/",
        }),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "",
          '- If you want to share a tip, you can [donate here](https://ko-fi.com/engmhajj/goal?g=6){:target="_blank"}',
          ...
          '- [TikTok](https://www.tiktok.com/@engmhajj){:target="_blank"}',
          '- [Instagram](https://www.instagram.com/link_arzu){:target="_blank"}',
          '- [GitHub](https://github.com/engmhajj){:target="_blank"}',
          '- [Threads](https://www.threads.net/@link_arzu){:target="_blank"}',
          '- [OnlyFans 🍆](https://engmhajj.com/assets/img/imgs/250126-whyugae.avif){:target="_blank"}',
          '- [YouTube (subscribe MF, subscribe)](https://www.youtube.com/engmhajj){:target="_blank"}',
          '- [Ko-Fi](https://ko-fi.com/engmhajj/goal?g=6){:target="_blank"}',
          "",
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "https://ko-fi.com/emgmhajj",
          "",
          "Follow me on twitter",
          "https://x.com/link_arzu",
          "",
          "My dotfiles (remember to star them)",
          "https://github.com/engmhajj/dotfiles-latest",
          "",
